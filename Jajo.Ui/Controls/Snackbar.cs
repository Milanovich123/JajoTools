...
public class Snackbar : System.Windows.Controls.ContentControl, ISnackbarControl, IIconControl, IAppearanceControl
{
    ...
    public static readonly DependencyProperty IconProperty = DependencyProperty.Register(nameof(Icon),
        typeof(DynamicSvg), typeof(Snackbar));
    ...
    /// <summary>
    /// Property for <see cref="TitleForeground"/>.
    /// </summary>
    ...
    /// <summary>
    /// Property for <see cref="DynamicSvg"/>.
    /// </summary>
    public static readonly DependencyProperty DynamicSvgProperty =
        DependencyProperty.Register(nameof(DynamicSvg),
            typeof(DynamicSvg), typeof(Snackbar), new PropertyMetadata(null));


    public DynamicSvg DynamicSvg
    {
        get => (DynamicSvg)GetValue(DynamicSvgProperty);
        set => SetValue(DynamicSvgProperty, value);
    }
    ...
    public DynamicSvg Icon
    {
        get => (DynamicSvg)GetValue(IconProperty);
    ...
    /// <summary>
    /// Gets the <see cref="RelayCommand"/> triggered after clicking close button.
    /// </summary>
...
#pragma warning restore CS4014
    ...
    {
#pragma warning disable CS4014
        ShowComponentAsync(message, appearance);
#pragma warning restore CS4014
...
//    {
//#pragma warning disable CS4014
//        ShowComponentAsync(title, message, appearance);
//#pragma warning restore CS4014
...
#pragma warning restore CS4014
    ...
    public async Task<bool> ShowAsync(string message, ControlAppearance appearance)
        => await ShowComponentAsync(message, appearance);
    ...
    //    => await ShowComponentAsync(title, message, appearance);
...
#pragma warning restore CS4014
    ...
    private async Task<bool> ShowComponentAsync(string message, ControlAppearance appearance)
    {
        await HideIfVisible();
    ...
    private async Task<bool> ShowComponentAsync(string title, string message, ControlAppearance appearance)
    {
        await HideIfVisible();
